...
import com.t440s.call.activities.PreviewActivity;
...
public class Recordings extends com.audio.libary.app.Recordings {
    View refresh;
    ...
    public void load(Uri mount, boolean clean, Runnable done) {
        ...
        if (!com.t440s.call.app.Storage.exists(getContext(), mount)) { // folder may not exist, do not show error
            scan(new ArrayList<com.t440s.call.app.Storage.Node>(), clean, done);
            return;
        }
        try {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final com.t440s.call.app.Storage.RecordingUri f = getItem(position);
        ...
        final boolean starb = com.audio.libary.app.MainApplication.getStar(getContext(), f.uri);
