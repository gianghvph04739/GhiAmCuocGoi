...
import com.t440s.audio.R;
import com.t440s.audio.animations.RecordingAnimation;
...
//                    select(position);
    ...
    protected FrameLayout getCheckBox(View v) {
    ...
    protected void selectToolbar(View v, boolean pressed) {
        FrameLayout cc = getCheckBox(v);
        if (pressed) {
            cc.setBackgroundColor(Color.TRANSPARENT);
        } else {
            cc.setBackgroundColor(Color.GRAY);
        }
    }
